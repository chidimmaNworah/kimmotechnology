...
const GrantDetail = ({ job, jobs, categories, relatedJobs = [] }) => {
  ...
  if (!job) {
    return (
      <div className="min-h-screen bg-[#060B18] flex items-center justify-center">
        <p className="text-[#94A3B8] text-lg">Grant not found.</p>
      </div>
    );
  }
  ...
  return (
    <>
      <Head>
        <title>{job?.title} | Apply for Funding Opportunities</title>
        <meta
          name="description"
          content={`Learn more about the ${job?.title} grant and apply for funding today. Eligibility, deadlines, and application process details included.`}
        />
        <meta
          property="og:title"
          content={`${job?.title} | Apply for Funding Opportunities`}
        />
        <meta
          property="og:description"
          content={`Find out how to apply for the ${job?.title} grant. Get details on eligibility, funding amount, deadlines, and more.`}
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content={`https://kimmotech.net/careers/grants/${job?.slug}`}
        />
        <meta
          property="og:image"
          content={
            job?.image ||
            "https://res.cloudinary.com/kimmoramicky/image/upload/v1742039039/kimmotech/default_grant_image.png"
          }
        />
      </Head>
      ...
      <div className="bg-[#060B18] min-h-screen flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 p-6 md:p-8">
          ...
          <p className="text-[#64748B] mb-8 text-sm">
            ...
            kimmotech.net/careers/grants --- ({comments.length}{" "}
