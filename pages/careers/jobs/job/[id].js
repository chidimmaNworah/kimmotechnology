  ...
  if (!job) {
    return (
      <div className="min-h-screen bg-[#060B18] flex items-center justify-center">
        <p className="text-[#94A3B8] text-lg">Job not found.</p>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="bg-[#060B18] min-h-screen flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 p-6 md:p-8">
          ...
          <p className="text-[#94A3B8]">{job.region}</p>
          <div className="mt-4">
          ...
          <div className="mt-8">
            ...
            <div
              className={`mt-2 text-[#CBD5E1] w-full ${styles.reactquillDetails}`}
          ...
          <h3 className="font-bold mt-8 text-[#F1F5F9]">Share this job:</h3>
          <Share post={job} />
